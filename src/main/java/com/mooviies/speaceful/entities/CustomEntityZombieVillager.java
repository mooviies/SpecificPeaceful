...
public class CustomEntityZombieVillager extends CustomEntityZombie {
    ...
    static {
        b = DataWatcher.a(EntityZombieVillager.class, DataWatcherRegistry.h);
        c = DataWatcher.a(EntityZombieVillager.class, DataWatcherRegistry.b);
    }
    ...
    public int getProfession() {
        return Math.max((Integer)this.datawatcher.get(c) % 6, 0);
    }
    ...
    public boolean isConverting() {
        return (Boolean)this.getDataWatcher().get(b);
    }

    protected void a(@Nullable UUID uuid, int i) {
        this.by = uuid;
        this.conversionTime = i;
        this.getDataWatcher().set(b, true);
