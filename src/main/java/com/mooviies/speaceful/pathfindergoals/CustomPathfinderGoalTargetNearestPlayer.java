...
public class CustomPathfinderGoalTargetNearestPlayer extends PathfinderGoal {
    ...
    public CustomPathfinderGoalTargetNearestPlayer(EntityInsentient entityinsentient) {
        ...
        this.c = new Predicate() {
            public boolean a(@Nullable Entity entity) {
                if (!(entity instanceof EntityHuman)) {
                    ...
                    double d0 = CustomPathfinderGoalTargetNearestPlayer.this.f();
                    ...
                    return (double)entity.g(CustomPathfinderGoalTargetNearestPlayer.this.b) > d0 ? false : PathfinderGoalTarget.a(CustomPathfinderGoalTargetNearestPlayer.this.b, (EntityLiving)entity, false, true);
                }
            }
    ...
    public boolean a() {
        ...
        if (list.isEmpty()) {
            ...
            if(this.e != null && SelectivePeaceful.getInstance().playerIsOnPeaceful(this.e.getUniqueID()))
                return false;
